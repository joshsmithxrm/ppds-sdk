...
| `IPluginStepManager` | Interface for plugin step management |
...
| `BypassCustomPlugins` | CustomLogicBypass | None | None, Synchronous, Asynchronous, All |
...
| Exporting | 1 | Exporting data (not used in import) |
...
| `src/PPDS.Migration/Progress/MigrationResult.cs` | Result and error models |
