...
/// <summary>
/// Produces completion items for SQL IntelliSense by combining ScriptDom-based
/// cursor context analysis with Dataverse metadata from <see cref="ICachedMetadataProvider"/>.
/// </summary>
/// <remarks>
/// This implementation replaces the PPDS.Dataverse version by using ScriptDom
/// tokens and AST instead of the custom SqlLexer/SqlParser for context analysis.
/// The public API is intentionally identical so consumers can switch without changes.
/// </remarks>
public sealed class SqlCompletionEngine
{
    ...
    private static SqlCompletion CreateAttributeCompletion(Dataverse.Metadata.Models.AttributeMetadataDto attr)
    {
