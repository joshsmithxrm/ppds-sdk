...
namespace PPDS.Dataverse.Generated
{
	...
	public partial class EnvironmentVariableValue : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<PPDS.Dataverse.Generated.AsyncOperation> environmentvariablevalue_AsyncOperations
		{
			get
			{
				return this.GetRelatedEntities<PPDS.Dataverse.Generated.AsyncOperation>("environmentvariablevalue_AsyncOperations", null);
			}
			set
			{
				this.OnPropertyChanging("environmentvariablevalue_AsyncOperations");
				this.SetRelatedEntities<PPDS.Dataverse.Generated.AsyncOperation>("environmentvariablevalue_AsyncOperations", null, value);
		...
		public PPDS.Dataverse.Generated.EnvironmentVariableDefinition environmentvariabledefinition_environmentvariablevalue
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.EnvironmentVariableDefinition>("environmentvariabledefinition_environmentvariablevalue", null);
			}
			set
			{
				this.OnPropertyChanging("environmentvariabledefinition_environmentvariablevalue");
				this.SetRelatedEntity<PPDS.Dataverse.Generated.EnvironmentVariableDefinition>("environmentvariabledefinition_environmentvariablevalue", null, value);
		...
		public PPDS.Dataverse.Generated.SystemUser lk_environmentvariablevalue_createdby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_environmentvariablevalue_createdby", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser lk_environmentvariablevalue_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_environmentvariablevalue_createdonbehalfby", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser lk_environmentvariablevalue_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_environmentvariablevalue_modifiedby", null);
			}
		}
		...
		public PPDS.Dataverse.Generated.SystemUser lk_environmentvariablevalue_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<PPDS.Dataverse.Generated.SystemUser>("lk_environmentvariablevalue_modifiedonbehalfby", null);
			}
		}
	}
}
